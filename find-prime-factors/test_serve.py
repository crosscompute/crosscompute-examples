...
crosscompute_path = os.path.abspath(os.path.join(configuration_folder,'..','..','crosscompute'))
...
def test_serve():
	tool_definition = get_tool_definition(tool_folder=configuration_folder, tool_name='', default_tool_name='')
